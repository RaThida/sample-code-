...
<?php
        ...
        if(isset($_POST['search'])){
          ...
          //4. get all products
          $stmt2 = $conn->prepare("SELECT * FROM products WHERE product_category=? AND product_price<=? LIMIT $offset,$total_record_per_page");
          $stmt2->bind_param('si',$category,$price);
          $stmt2->execute();
          $products= $stmt2->get_result();

          //return all product--> if you have small website 1000
        }else{
...
?>
    ...
    <section  id="search" class="my-5 py-5 ms-2">
      ...
      <form id="form-search" action="shop.php" method="POST">
      ...
      <div class="row mx-auto container-fluid">
          <?php while($row = $products->fetch_assoc()){ ?>
              <div onclick="window.location.href='single_product.php';" class="product text-center col-lg-3 col-md-4 col-sm-12">
                <img class="img-fluid md-3 shop-image" src="assets/imgs/<?php echo $row['product_image']; ?>"/>
                <div class="star">
